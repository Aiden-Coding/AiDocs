...
JVM 内部的引用，如基本数据类型对应的 Class 对象，常驻异常对象（NullPointerException 等），系统类加载器。
 ...
 **答**：
 ...
 1. **空间分配担保失败**：Promotion Failure 或 Concurrent Mode Failure（CMS 收集器特有）。
