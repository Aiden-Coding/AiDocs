...
const FeatureList: FeatureItem[] = [
  {
    title: '系统化知识体系',
    imgSrc: require('@site/static/img/feature_system.png').default,
    description: (
      <>
  ...
  {
    title: '深度原理解析',
    imgSrc: require('@site/static/img/feature_depth.png').default,
    description: (
      <>
  ...
  {
    title: '实战经验总结',
    imgSrc: require('@site/static/img/feature_practice.png').default,
    description: (
      <>
