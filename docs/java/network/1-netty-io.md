...
> **学习路径引导**：如果您是初学者，建议先阅读 [Netty 快速起步：从 Hello World 走进高性能网络编程](3-netty-quickstart.md) 了解基础用法，再深入本篇探究底层机制。
...
## 二、 JDK NIO 的 epoll 空轮询问题与 Netty 的规避方案
...
## 三、 Netty 底层架构核心：主从 Reactor 与内存零拷贝
